...
static void handle_signals(struct sigaction *old_int, struct sigaction *old_quit, int restore);
static int handle_heredoc_parent(pid_t pid, int hered_fd, struct sigaction *old_int, struct sigaction *old_quit);
